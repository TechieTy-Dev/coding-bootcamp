	...
	if (slide === "tanya") {
			...
			<div className="App">
				<section className="pt-12 lg:flex lg:flex-row-reverse lg:items-center lg:justify-center bg-white ">
					<div className="bg w-[100%] h-[50vh] pt-8 relative lg:ml-[-12rem] lg:h-[80vh] lg:w-[80%]">
						...
						/>
						<div className="flex bg-white w-[5.5rem] absolute left-[200px] bottom-4 p-2.5 rounded-full justify-between shadow-md   lg:bottom-[2.25rem] lg:left-[215px]">
							{/* Prev Btn */}
					...
					{/* Testimonial */}
					<div className=" mt-12 flex flex-col items-center justify-center lg:w-[80%] lg:text-left lg:items-start lg:mr-[-16rem] lg:pl-44 lg:z-10">
						...
						{/* User Details */}
						<div className="mt-4 lg:text-left lg:flex lg:gap-2 lg:pt-8	">
							{/* Name */}
							<h1 className="font-bold text-darkblue"> Tanya Sinclair</h1>
							{/* Job Title */}
							<span className="font-light text-lightblue"> UX Engineer</span>
						</div>
					</div>
				</section>
		...
		"
					...
					<div className=" mt-12 flex flex-col items-center justify-center lg:w-[80%] lg:text-left lg:items-start lg:mr-[-16rem] lg:pl-44 lg:z-10">
						...
						<div className="mt-4 lg:text-left lg:flex lg:gap-2 lg:pt-8	">
							{/* Name */}
							<h1 className="font-bold text-darkblue"> John Tarkpor</h1>
							{/* Job Title */}
							<span className="font-light text-lightblue">
								{" "}
